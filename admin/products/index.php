                                ...
                                foreach ($products as $product)
                                {
                                    ?>
                                        <tr>
                                            ...
                                            <td><a class="btn update-btn" href="update.php?id=<?php echo $product['pID'] ?>">Sửa</a>
                                            <a class="btn update-btn" href="delete.php?id=<?php echo $product['pID'] ?>">Xóa</a></td>
                                        </tr>
                                    <?php 
                                }
                            } else {
                                ?> <tr><td colspan="6">Chưa có sản phẩm nào</td></tr> <?php
                            }
                        ?>
                    </table>
                </div>
