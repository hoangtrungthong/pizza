<section class="products" id="products">
    ...
    <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <div>
                        ...
                        ?>
                            <a href="login/" name="add" class="btn">đặt món</a>
                            <a href="login/" name="add" class="btn btn-cart" title="Thêm vào giỏ hàng">
                                <img src="images/add-to-cart.png" alt="">
                            </a>
                        <?php } ?>
                    </div>
        ...
        <div class="box">
            <img class="image" src="images/p2-lamacun.jpg" alt="Hình Ảnh">
            <span>150k - 300k</span>
            <div class="content">
                <h3>Lamacun</h3>
        ...
        <div class="box">
            <img class="image" src="images/p3-tarte.jpg" alt="Hình Ảnh">
            <span>150k - 300k</span>
            <div class="content">
                <h3>Tarte Flambee</h3>
        ...
        <div class="box">
            <img class="image" src="images/p4-okono.jpg" alt="Hình Ảnh">
            <span>150k - 300k</span>
            <div class="content">
                <h3>Okonomiyaki</h3>
        ...
        <div class="box">
            <img class="image" src="images/p5-langos.jpg" alt="Hình Ảnh">
            <span>150k - 300k</span>
            <div class="content">
                <h3>Lángos</h3>
        ...
        <div class="box">
            <img class="image" src="images/p6-zapie.jpg" alt="Hình Ảnh">
            <span>150k - 300k</span>
            <div class="content">
                <h3>Sfiha</h3>
        ...
        <div class="box">
            <img class="image" src="images/p7-bulgogi.jpg" alt="Hình Ảnh">
            <span>150k - 300k</span>
            <div class="content">
                <h3>Zapiekanka</h3>
        ...
        <div class="box">
            <img class="image" src="images/p8-neapo.jpg" alt="Hình Ảnh">
            <span>150k - 300k</span>
            <div class="content">
                <h3>Bulgogi</h3>
        ...
        <div class="box">
            <img class="image" src="images/p9-deep.jpg" alt="Hình Ảnh">
            <span>150k - 300k</span>
            <div class="content">
                <h3>Deep-Dish</h3>
